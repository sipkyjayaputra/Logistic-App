...
const CommercialInvoiceAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetchWithAuth('commercial-invoices', {
        method: 'POST',
        headers: {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Success!',
        text: 'Commercial invoice added successfully!',
      }).then(() => {
        navigate('/commercial-invoices'); // Redirect to the list page after successful submission
      });
    } catch (error) {
      setError('Failed to add commercial invoice');
      console.error('Error:', error);
      Swal.fire({
        icon: 'error',
        title: 'Error!',
        text: 'Failed to add commercial invoice. Please try again.',
      });
    }
  };
  ...
  return (
    <Layout>
      <div className="container mt-5">
        <div className="display-6">Add New Commercial Invoice</div>
        {error && (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group mt-3">
            ...
            <input
              ...
              id="issuer_phone"
              name="issuer_phone"
              placeholder="Enter issuer phone number"
          ...
          <div className="form-group mt-3">
            <label htmlFor="no_sc" className="lead">SC No</label>
            <input
              type="text"
              className="form-control form-control-sm"
              id="no_sc"
...
export default CommercialInvoiceAdd;
